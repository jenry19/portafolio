        ...
        <div class="row">
            ...
            <div class="col-12 col-xl-4">
                <div class="card h-100">
                    ...
                    <div class="card-body p-3">
                        <p class="text-sm">
                            ¡Hola, me llamo Henry! Soy un programador de software entusiasta por la tecnología y la
                            innovación. Mi código es mi lienzo y las posibilidades son infinitas. ¡Listo para codificar
                            el futuro juntos! 👨‍💻💡 #HenryElProgramador.
                        </p>
                        <hr class="horizontal gray-light my-4">
                        <ul class="list-group">
                            <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Full
                                    Name:</strong> &nbsp; Henry Castro Mayoral</li>
                            <li class="list-group-item border-0 ps-0 text-sm"><strong
                                    class="text-dark">Mobile:</strong> &nbsp; (+57) 3002960455</li>
                            <li class="list-group-item border-0 ps-0 text-sm"><strong
                                    class="text-dark">Email:</strong> &nbsp; henrycastrom19@mail.com</li>
                            <li class="list-group-item border-0 ps-0 text-sm"><strong
                                    class="text-dark">Location:</strong> &nbsp; Colombia</li>
                            <li class="list-group-item border-0 ps-0 pb-0">
                                {{-- <strong class="text-dark text-sm">Social:</strong> &nbsp;
                  <a class="btn btn-facebook btn-simple mb-0 ps-1 pe-2 py-0" href="javascript:;">
                    <a href="https://api.whatsapp.com/send/?phone=3002960455  "><i class="fa-brands fa-whatsapp"></i></a>
                  </a>
                    ...
                    <div class="card-body d-flex flex-column justify-content-center text-center">
                        <a href="javascript:;">
                            ...
                            <a href="/empleado/create">
                                <h5 class=" text-secondary"> New empleado </h5>
                            </a>
                        </a>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body p-3">
                        <div class="row">
                          ...
                          <script>
                              function showAlert() {
                                  window.alert("Función No Disponible Por el Momento Gracias Por entender");
                              }
                          </script>
