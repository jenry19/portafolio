                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ $empleado->Foto }}" class="avatar avatar-sm me-3" alt="user">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{ $empleado->Nombre }} {{ $empleado->Apellidos }}</h6>
                            <p class="text-xs text-secondary mb-0">{{ $empleado->Correo }}</p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{ $empleado->Telefono }}</p>
                        {{-- <p class="text-xs text-secondary mb-0">Organization</p> --}}
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">{{ $empleado->Sexo }}</span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">{{ $empleado->id }}</span>
                      </td>
